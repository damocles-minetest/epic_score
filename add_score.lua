local update_formspec = function(meta)
	...
	meta:set_string("infotext", "Add score block: " .. amount .. " points")
...
minetest.register_node("epic_score:add", {
	description = "Epic score add block",
	tiles = {
		"epic_node_bg.png",
		"epic_node_bg.png",
		"epic_node_bg.png",
  ...
  on_receive_fields = function(pos, _, fields, sender)
    ...
    on_enter = function(_, meta, player, ctx)
      ...
      local add_amount = meta:get_int("amount")
      local score = player_meta:get_int("epic_score")
      score = score + add_amount
